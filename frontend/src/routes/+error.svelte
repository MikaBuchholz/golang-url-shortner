<div class="grid h-screen px-4 bg-slate-800 place-content-center">
	<div class="text-center">
		<h1 class="font-black text-gray-200 text-9xl">503</h1>

		<p class="text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">Uh-oh!</p>

		<p class="mt-4 text-slate-200">Service currently unavailable :|</p>
